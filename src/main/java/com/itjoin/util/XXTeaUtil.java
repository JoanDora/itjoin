 ...
 * <p>
 * 
 * 采用xxtea对称加密解密算法, 速度快、效率高，实现也非常简单
 * 
 * </p>
 * 
 * @author hz14121005
 * @date 2015-10-13 下午5:05:13
 * @version
 */
public class XXTeaUtil {
	...
	String url="www.baidu/user.com";
	String a=Encrypt(url, "aaa");
	System.out.println("加密后==="+a);
	String b=Decrypt(a, "aaa");
	System.out.println("解密密后==="+a);
    }
